...
def _construct_edge_list_from_cluster2(X, clusters=[10]):
    """
...
def construct_H_with_Kmeans(X, clusters=[20], split_diff_scale=False):
    if len(X.shape) != 2:
    ...
    for clusters in clusters:
        H_tmp = _construct_edge_list_from_cluster2(X, clusters)
